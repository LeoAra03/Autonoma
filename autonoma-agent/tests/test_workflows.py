...
def test_notes_and_registry(tmp_path):
    ...
    bundle_file = engine.save_findings(
        "topic", [SearchHit("Title", "https://example.com", "snippet", extra="extra", content="body")], notes="note"
    )
...
def test_orchestration_tool_cycle(tmp_path):
    ...
    call = {
        "type": "function",
        "id": "1",
        "function": {"name": "save_knowledge", "arguments": '{"title":"test","content":"body"}'},
    }
    responses = iter(
        [
